...
FirenetPlatform.prototype.configurationRequestHandler = function(context, request, callback) {
	...
	if (request && request.response && request.response.inputs && request.response.inputs.name) {
		...
		callback(null, "platform", true, {"platform":"FirenetPlatform", "otherConfig":"SomeData"});
		return;
	}
...
FirenetPlatform.prototype.addAccessory = function(accessoryName) {
...
FirenetPlatform.prototype.removeAccessory = function() {
